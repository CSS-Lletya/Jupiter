...
public final class NPCCombatDispatcher {
	...
	public static void load() {
		List<MobCombatInterface> interfaces = Utils.getClassesInDirectory("com.jupiter.combat.npc.combat.scripts.impl").stream().map(clazz -> (MobCombatInterface) clazz).collect(Collectors.toList());
