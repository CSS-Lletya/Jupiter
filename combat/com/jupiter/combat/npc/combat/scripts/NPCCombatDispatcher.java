...
import com.jupiter.combat.npc.combat.scripts.impl.DefaultCombat;
...
public final class NPCCombatDispatcher {
	...
	public static void load() {
		List<MobCombatInterface> interfaces = Utility.getClassesInDirectory("com.jupiter.combat.npc.combat.scripts.impl").stream().map(clazz -> (MobCombatInterface) clazz).collect(Collectors.toList());
