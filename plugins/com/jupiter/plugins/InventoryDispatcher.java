...
public final class InventoryDispatcher {
	...
	public static void load() {
		List<InventoryType> interfaces = Utils.getClassesInDirectory("com.jupiter.plugins.inventory.impl").stream().map(clazz -> (InventoryType) clazz).collect(Collectors.toList());
