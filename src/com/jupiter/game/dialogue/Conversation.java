package com.jupiter.game.dialogue;
...
public class Conversation {
    ...
    public Dialogue addPlayer(Mood expression, String text) {
    	return addNext(new PlayerStatement(expression, text));
    }
    
    public Dialogue addPlayer(Mood expression, String text, Runnable extraFunctionality) {
    ...
    public Dialogue addNPC(int npcId, Mood expression, String text) {
    	this.npcId = npcId;
    	return addNext(new NPCStatement(npcId, expression, text));
    }
    
    public Dialogue addNPC(int npcId, Mood expression, String text, Runnable extraFunctionality) {
    	this.npcId = npcId;
    	return addNext(new Dialogue(new NPCStatement(npcId, expression, text), extraFunctionality));
    }
    
    public Dialogue addNPC(Mood expression, String text) {
    	return addNext(new NPCStatement(npcId, expression, text));
    }
    
    public Dialogue addNPC(Mood expression, String text, Runnable extraFunctionality) {
    	return addNext(new Dialogue(new NPCStatement(npcId, expression, text), extraFunctionality));
    }
