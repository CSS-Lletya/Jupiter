package com.jupiter.network.utility;
...
public final class Huffman {
	...
	public static int sendEncryptMessage(OutputStream stream, String message) {
		try {
			...
			byte[] messageData = CacheUtility.getFormatedMessage(message);
	...
	public static final String readEncryptedMessage(int maxLength, InputStream stream) {
		try {
			...
			String message = CacheUtility.getUnformatedMessage(messageDataLength, 0, messageData);
			return message;
		} catch (Throwable e) {
			return "";
		}
